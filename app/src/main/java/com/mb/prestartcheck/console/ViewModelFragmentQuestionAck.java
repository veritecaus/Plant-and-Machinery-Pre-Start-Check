...
public class ViewModelFragmentQuestionAck extends ViewModelQuestionNavigator {

    private long questionId;

    public ViewModelFragmentQuestionAck(Application app, long qid) {
    ...
    public void recordResponse()
    {
        ...
        if (response != null)
        {
            ...
            response.setOperatorResponse("Acknowledged");
        }
